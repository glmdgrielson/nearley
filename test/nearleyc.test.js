...
describe("bin/nearleyc", function () {
  ...
  it('builds for ES5', function (done) {
  ...
  it('builds for CoffeeScript', function (done) {
    const {
      outPath, 
      stdout, 
      stderr
  ...
  it('builds for TypeScript', function (done) {
    this.timeout(0); // It takes a while to run tsc!
...
describe('nearleyc', function () {
  ...
  it('handles case-insensitive strings', function () {
